...
-spec map_errors(
    {ok, CLC} | {error, list(decode_error())},
...
-spec result(
    fun((dynamic()) -> {ok, CMH} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CMJ} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, {ok, CMH} | {error, CMJ}} |
    {error, list(decode_error())}).
...
-spec list(fun((dynamic()) -> {ok, CMO} | {error, list(decode_error())})) -> fun((dynamic()) -> {ok,
        list(CMO)} |
    {error, list(decode_error())}).
list(Decoder_type) ->
...
-spec optional(fun((dynamic()) -> {ok, CMT} | {error, list(decode_error())})) -> fun((dynamic()) -> {ok,
        gleam@option:option(CMT)} |
    {error, list(decode_error())}).
optional(Decode) ->
...
-spec field(
    any(),
    fun((dynamic()) -> {ok, CND} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, CND} | {error, list(decode_error())}).
...
) -> fun((dynamic()) -> {ok, {COE, COG}} | {error, list(decode_error())}).
...
) -> fun((dynamic()) -> {ok, {COJ, COL, CON}} | {error, list(decode_error())}).
...
) -> fun((dynamic()) -> {ok, {COQ, COS, COU, COW}} |
    {error, list(decode_error())}).
...
) -> fun((dynamic()) -> {ok, {COZ, CPB, CPD, CPF, CPH}} |
    {error, list(decode_error())}).
...
) -> fun((dynamic()) -> {ok, {CPK, CPM, CPO, CPQ, CPS, CPU}} |
    {error, list(decode_error())}).
...
-spec map(
    fun((dynamic()) -> {ok, CPX} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CPZ} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, gleam@map:map_(CPX, CPZ)} |
    {error, list(decode_error())}).
...
-spec any(list(fun((dynamic()) -> {ok, CQI} | {error, list(decode_error())}))) -> fun((dynamic()) -> {ok,
        CQI} |
    {error, list(decode_error())}).
any(Decoders) ->
...
-spec decode4(
    fun((CRA, CRB, CRC, CRD) -> CRE),
    fun((dynamic()) -> {ok, CRA} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CRB} | {error, list(decode_error())}),
...
-spec decode5(
    ...
    fun((dynamic()) -> {ok, CRO} | {error, list(decode_error())})
...
-spec decode6(
    fun((CRW, CRX, CRY, CRZ, CSA, CSB) -> CSC),
    ...
    fun((dynamic()) -> {ok, CSA} | {error, list(decode_error())}),
    fun((dynamic()) -> {ok, CSB} | {error, list(decode_error())})
) -> fun((dynamic()) -> {ok, CSC} | {error, list(decode_error())}).
...
-spec decode7(
    fun((CSK, CSL, CSM, CSN, CSO, CSP, CSQ) -> CSR),
...
-spec decode8(
    fun((CTA, CTB, CTC, CTD, CTE, CTF, CTG, CTH) -> CTI),
...
-spec decode9(
    fun((CTS, CTT, CTU, CTV, CTW, CTX, CTY, CTZ, CUA) -> CUB),
